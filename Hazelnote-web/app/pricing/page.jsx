        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="pricing-card bg-gray-800/50 backdrop-blur-lg border-2 border-gray-700 rounded-3xl p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-green-400" /><span className="text-gray-300">3 study sets per month</span></div>
              ...
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-green-400" /><span className="text-gray-300">Max 2 AI Tutor chats per set</span></div>
              <div className="flex items-start gap-3 opacity-50"><X className="w-5 h-5 text-red-400" /><span className="text-gray-500">AI podcasts</span></div>
            </div>
          </div>
          ...
          <div className="pricing-card bg-gradient-to-br from-green-900/40 to-blue-900/40 backdrop-blur-lg border-2 border-green-500 rounded-3xl p-8 relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"><span className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-4 py-1 rounded-full text-sm font-bold">MOST POPULAR</span></div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-green-400" /><span className="font-semibold">Unlimited study sets</span></div>
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-green-400" /><span>PDF upload (up to 50MB)</span></div>
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-green-400" /><span>Unlimited AI Tutor chats</span></div>
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-green-400" /><span>AI Podcasts & Translation</span></div>
            </div>
          </div>
          
          {/* MAX */}
          <div className="pricing-card bg-gray-800/50 backdrop-blur-lg border-2 border-purple-500 rounded-3xl p-8">
            <h3 className="text-2xl font-extrabold mb-2">Max</h3>
            <div className="mb-8 mt-4">
              <span className="text-5xl font-extrabold">{isAnnual ? '$21.25' : '$25'}</span>
              <span className="text-gray-400 text-sm">{isAnnual ? '/mo (billed annually)' : '/mo'}</span>
            </div>
            <a href="/login" className="block w-full py-3 px-6 text-center bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 font-bold rounded-xl transition mb-8">Upgrade to Max</a>
            <div className="space-y-4">
              <div className="flex items-start gap-3"><Zap className="w-5 h-5 text-purple-400" /><span className="font-semibold">Everything in Pro, plus:</span></div>
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-purple-400" /><span>Long-form Essay grading in Exams</span></div>
              <div className="flex items-start gap-3"><Check className="w-5 h-5 text-purple-400" /><span>30 Questions per Exam Set</span></div>
            </div>
          </div>
        </div>
      </section>
